...
import { ED25519_ALG, ED25519_CURVE, ED25519_USE, ED25519_BYTES, ED25519_PUBLIC_OPS } from "./shared.js";


export function assertEd25519PublicKey(jwk: JsonWebKey, context = "key"): void {
  ...
  if (jwk.key_ops) {
    ...
    for (const op of ops) {
      if (
        !ED25519_PUBLIC_OPS.includes(op as (typeof ED25519_PUBLIC_OPS)[number])
      ) {
        throw new CryptosuiteError(
          "ED25519_KEY_OPS_INVALID",
